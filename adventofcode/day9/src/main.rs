...
fn extrapolate_previous(history: &Vec<i64>) -> i64 {
    let mut differences = vec![history.clone()];
...
fn day9part2(histories: &Vec<Vec<i64>>) -> i64 {
    histories
        .iter()
...
fn main() -> Result<()> {
    ...
    println!("Day 9 part 2 answer: {}", day9part2(&histories));
...
10 13 16 21 30 45";
    ...
    #[test]
    fn day9part2_returns_correct_value() -> Result<()> {
        const INPUT: &str = "0 3 6 9 12 15
1 3 6 10 15 21
10 13 16 21 30 45";
        let histories = parse_histories(&INPUT.to_owned())?;

        assert_eq!(day9part2(&histories), 2);
